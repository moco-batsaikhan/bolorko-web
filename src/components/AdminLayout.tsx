      ...
      <div className="max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="mb-4 sm:mb-8 px-1">
          ...
          <p className="text-sm sm:text-base text-gray-600">
            Вэбсайтын агуулга болон хэрэглэгчдийг удирдах
          </p>
        </div>

        {/* Гар утаснаас орох үед: хажуугийн цэсийг зогсоож, хажуу тийш
            гулсдаг товчлуурын мөр болгож толгойн доор харуулна */}
        ...
        <div className="flex flex-col lg:flex-row">
          {/* Sidebar Navigation — зөвхөн том дэлгэцэнд */}
          <div className="hidden lg:block w-64 bg-white rounded-lg shadow-sm h-fit mr-8 flex-shrink-0">
            <div className="p-6">
